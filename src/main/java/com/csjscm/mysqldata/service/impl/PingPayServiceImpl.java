...
import com.csjscm.config.payconfig.PingConfig;
import com.csjscm.oracledata.dao.BidRefundLogsMapper;
import com.csjscm.oracledata.dao.CabinetOnlinePayMapper;
...
import com.csjscm.mysqldata.dao.SettleAccountMapper;
...
public class PingPayServiceImpl implements PingPayService {
    ...
    @Resource
    private CabinetOnlinePayMapper cabinetOnlinePayMapper;
    @Override
    ...
    @Override
    public Map<String, Object> showCabinetOnlinePay() {
        Map<String,Object> map=Maps.newHashMap();
       ...
       // List<CabinetOnlinePay> cabinetOnlinePays = cabinetOnlinePayMapper.selectByExample(cabinetOnlinePayExample);
        ...
        if(cabinetOnlinePays.size()>0){
            map.put("status",0);
            map.put("cabinetOnlinePays",cabinetOnlinePays);
        }else {
            map.put("status",-1);
        }
