			...
			<div class="header-wrap">
				...
				<div class="blog-nav pull-right">
					<ul class="layui-nav pull-left">
					  <li class="layui-nav-item"><a href="index.ftl">首页</a></li>
					  <li class="layui-nav-item"><a href="message.ftl">留言</a></li>
					  <li class="layui-nav-item  layui-this"><a href="/blog/about.ftl">关于</a></li>
					</ul>
